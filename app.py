...
app = Flask(__name__)
app.secret_key = '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'  # Set your secret key (or use an environment variable)
